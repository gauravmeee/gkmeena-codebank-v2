...
class NotificationService {
  ...
  async setupOnMessage(callback) {
    ...
    onMessage(this.messaging, async (payload) => {
      ...
      const { type, platform, url } = payload.data;
      ...
      if (this.registration) {
        ...
        const notificationOptions = {
          body,
          icon: platform ? `${baseUrl}/assets/contests/${platform.toLowerCase()}.png` : `${baseUrl}/assets/contests/default.png`,
          badge: `${baseUrl}/assets/contests/default.png`,
          vibrate: [100, 50, 100],
          data: {
            ...payload.data,
            url: url || this.getDefaultUrl(type, platform)
          },
